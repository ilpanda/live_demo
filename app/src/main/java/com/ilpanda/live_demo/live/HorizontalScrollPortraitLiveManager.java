 ...
 * 水平滑动竖屏直播间,实现效果类似抖音
 */
public class HorizontalScrollPortraitLiveManager implements LivePlayListener, View.OnClickListener, TCInputTextMsgDialog.OnTextSendListener, TCChatMsgListAdapter.OnItemClickListener {
    ...
    public HorizontalScrollPortraitLiveManager(Activity activity) {
    ...
    private void initView() {
        // 播放器根布局
        mRoomContainer = (RelativeLayout) LayoutInflater.from(mContext).inflate(R.layout.layout_horizontal_scroll_portrait_live, null);


        View emptyView = LayoutInflater.from(mContext).inflate(R.layout.layout_live_empty_view, null, false);
        ViewList.add(emptyView);

        RelativeLayout liveView = (RelativeLayout) LayoutInflater.from(mContext).inflate(R.layout.layout_live_portrait_view, null, false);
        mLiveView = liveView;
        ViewList.add(liveView);

        ViewPager viewPager = mRoomContainer.findViewById(R.id.view_pager);
        ...
        // 加载中
        mLoadingView = mLiveView.findViewById(R.id.play_loading);
        mLiveView.findViewById(R.id.play_iv_back).setOnClickListener(this);

        // 昵称
        mTvNick = mLiveView.findViewById(R.id.tv_nick);
        // 位置
        mTvLocation = mLiveView.findViewById(R.id.tv_location);
        // 关注
        mTvFollow = mLiveView.findViewById(R.id.tv_follow);
        mTvFollow.setOnClickListener(this);

        // 礼物弹幕
        mGiftAnimatorView = mLiveView.findViewById(R.id.view_gift_animator);
        ...
        // 头像
        mIvAvatar = mLiveView.findViewById(R.id.iv_avatar);
        mIvAvatar.setOnClickListener(this);

        // 主播地理位置
        mLlLocation = mLiveView.findViewById(R.id.ll_location);

        // 点击进入直播广场
        mLiveView.findViewById(R.id.ll_live_list).setOnClickListener(this);

        // 分享
        mLiveView.findViewById(R.id.iv_share).setOnClickListener(this);

        // 点赞
        mLiveView.findViewById(R.id.rly_like).setOnClickListener(this);

        // 右上角返回
        mLiveView.findViewById(R.id.iv_back).setOnClickListener(this);

        // 聊天输入框
        mBtnInput = mLiveView.findViewById(R.id.btn_message_input);
        mBtnInput.setOnClickListener(this);

        // 聊天室消息列表
        mListViewMsg = (ListView) mLiveView.findViewById(R.id.lv_chat_msg);
        ...
        // 点赞数目
        mTvLikeCount = mLiveView.findViewById(R.id.tv_like_count);

        // 点赞动画
        mHeartLayout = mLiveView.findViewById(R.id.heart_layout);
